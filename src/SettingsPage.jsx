...
export default function SettingsPage({ family, save, back, onExport, onImport, onReset, qariId = DEFAULT_QARI_ID, saveQari, locale, saveLocale, theme = 'light', setTheme, ui }) {
  ...
  return <main className="app-page pb-32"><div className="page-shell page-shell-settings">
    ...
    <SettingsAccordion id="welcome" openSection={openSection} onToggle={toggleSection} content={<button type="button" onClick={() => window.localStorage.removeItem('hasSeenAgentWelcome')} className="secondary-button mt-5"><Settings size={18}/>Tampilkan lagi saat beranda dibuka</button>}><div className="settings-section-heading"><p className="step-label">TEMAN HAFALAN</p><span>Popup sambutan</span><p>Atur ulang popup Teman Hafalan untuk mengujinya kembali saat membuka beranda.</p></div></SettingsAccordion>
